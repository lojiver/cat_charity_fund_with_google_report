...
async def check_charity_project_invested_sum(project: CharityProject, new_amount: int):
...
async def check_charity_project_already_invested(charity_project: CharityProject):
